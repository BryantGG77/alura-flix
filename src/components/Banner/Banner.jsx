...
export const Banner = () => {
    return (
        <section className="relative w-full h-[722px] hidden md:block">
            ...
            <section className="relative flex flex-col justify-center items-center w-full h-full px-10 py-5 gap-12 xl:flex-row">
                <div className="flex flex-col gap-10">
                    <Categoria title="Front end" color="#6bd1ff" />
                    <div className="max-w-[662px] flex flex-col gap-4">
                        <h2 className="text-5xl ">Qué significa pensar como programador</h2>
                ...
                <div className="relative flex justify-center items-center rounded-2xl border-4 border-[#6BD1FF] borde1">
                    <iframe className="rounded-2xl border-0" width="560" height="315" src="https://www.youtube.com/embed/ov7vA5HFe6w?si=XKvIuZWUEtExr5x2" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
